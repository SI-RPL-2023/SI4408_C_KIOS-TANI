    ...
    <div class="" style="height: 90vh;">
        <div id="carouselExampleCaptions" class="relative" style="height: 90vh;" data-te-carousel-init
            ...
            <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
                ...
                <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                    style="height: 90vh;" data-te-carousel-item style="backface-visibility: hidden">
                    <img src="/assets/home3.png" class="block object-cover" alt="..." />
                </div>
            </div>
        ...
        <div id="categories">
            ...
            <div class="flex mt-10">
                <div class="w-11/12 flex justify-around">
                    <div class="w-1/12 grid place-items-center bg-[#8EE6AC] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/sets.png" alt="">
                            <p class="font-bold">Sets</p>
                        </div>
                    </div>
                    <div class="w-1/12 grid place-items-center bg-[#DDFFE9] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/fruit.png" alt="">
                            <p class="font-bold">Fruits</p>
                        </div>
                    </div>
                    <div class="w-1/12 grid place-items-center bg-[#F8E9F1] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/veggies.png" alt="">
                            <p class="font-bold">Veegies</p>
                        </div>
                    </div>
                    <div class="w-1/12 grid place-items-center bg-[#D4D1F6] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/fungi.png" alt="">
                            <p class="font-bold">Fungi</p>
                        </div>
                    </div>
                    <div class="w-1/12 grid place-items-center bg-[#FAFEC7] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/greenery.png" alt="">
                            <p class="font-bold">Greenery</p>
                        </div>
                    </div>
                    <div class="w-1/12 grid place-items-center bg-[#FFD4CE] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/spices.png" alt="">
                            <p class="font-bold">Spices</p>
                        </div>
                    </div>
                    <div class="w-1/12 grid place-items-center bg-[#EFECFF] rounded-xl p-5">
                        <div class="flex flex-col items-center">
                            <img class="w-8/12" src="/assets/svg/seeds.png" alt="">
                            <p class="font-bold">Seeds</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-between bg-white w-3/12 p-4 rounded-xl shadow-lg">
                <div class="w-6/12">
                    <p class="text-xl font-bold">Vegetarian and<br>
                        Vegan Products</p>
                    <button class="bg-[#0B714C] text-white px-3 py-1 rounded-full mt-10">Show Now</button>
                </div>
                <div class="w-5/12">
            ...
            <div class="grid grid-cols-4 place-items-center place-content-evenly mt-5 gap-y-10 mx-auto">
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img class="object-contain" src="/assets/photo/strawberry.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Fruits</p>
                        <p class="font-bold">Strawberry</p>
                        <div class="flex">
                        ...
                        <p class="text-sm text-[#969696]">Price per kg</p>
                        <div class="flex justify-between items-center">
                            <p class="text-xl font-bold">Rp. 27.000</p>
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img class="object-contain" src="/assets/photo/turnip.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Veggies</p>
                        <p class="font-bold">Turnip</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img class="object-contain" src="/assets/photo/potato.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Veggies</p>
                        <p class="font-bold">Potato</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <p class="text-sm text-[#969696]">Price per kg</p>
                        <div class="flex justify-between items-center">
                            <p class="text-xl font-bold">Rp. 29.000</p>
                            <div class="bg-[#42D48E] px-2 py-1 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="white" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12  mx-auto h-40 grid place-items-center">
                        <img class="object-contai" src="/assets/photo/onion.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Veggies</p>
                        <p class="font-bold">Red Onion</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <p class="text-sm text-[#969696]">Price per kg</p>
                        <div class="flex justify-between items-center">
                            <p class="text-xl font-bold">Rp. 35.000</p>
                            <div class="bg-[#42D48E] px-2 py-1 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="white" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img src="/assets/photo/garlic.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Veggies</p>
                        <p class="font-bold">Garlic</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <p class="text-sm text-[#969696]">Price per 100 gr</p>
                        <div class="flex justify-between items-center">
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img class="object-contain" src="/assets/photo/fennel.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Seeds</p>
                        <p class="font-bold">Fennel</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img class="object-contain" src="/assets/photo/wortel.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Veggies</p>
                        <p class="font-bold">Carrot</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <p class="text-sm text-[#969696]">Price per kg</p>
                        <div class="flex justify-between items-center">
                            <p class="text-xl font-bold">Rp. 15.000</p>
                            <div class="bg-[#42D48E] px-2 py-1 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="white" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="w-8/12 bg-white shadow-lg p-3 hover:scale-95 rounded-2xl transition-all cursor-pointer">
                    ...
                    <div class="w-10/12 mx-auto h-40 grid place-items-center">
                        <img src="/assets/photo/redchili.png" alt="">
                    </div>
                    <div>
                        <p class="text-[#969696] font-bold">Veggies/Spices</p>
                        <p class="font-bold">Red Chili</p>
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#FFCB45" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#FFCB45" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="flex gap-6 justify-center mt-7">
                <div class="relative bg-white shadow-md w-5/12 h-3/5 p-10">
                    ...
                    <div class="flex justify-end absolute bottom-10 right-12">
                        <button class="px-6 py-3 bg-[#42D48E] font-extrabold rounded-xl text-white">See More...</button>
                    </div>
                </div>
            ...
            <form class="w-1/2" action="">
                <div class="flex items-center gap-10 w-full">
                    <div class="w-5/12">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" placeholder="enter a valid email address"
                            :value="old('email')" required autocomplete="username" />
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>
                    <div class="w-5/12">
                        <x-input-label for="name" :value="__('Name')" />
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" placeholder="enter your name"
                ...
                <div class="flex items-center gap-10">
                    <div class="w-5/12">
                        ...
                        <x-text-input id="message" class="block mt-1 w-full" type="text" name="message" :value="old('name')" placeholder="enter your message"
